...
public class p034_SimpleToolbar extends JFrame{
...
//		ImageIcon iconExitTB = new ImageIcon(getClass().getResource("exit_small.png"));
		JButton exitTB = new JButton(iconExit);
		toolbar.add(exitTB);
		exitTB.addActionListener(new CloseApp());
